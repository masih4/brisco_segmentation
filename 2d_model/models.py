# attention unet 
#(from: https://github.com/bnsreenu/python_for_microscopists/tree/fc1664ed75069bedae351a02136ec1c9dd08de7a)
...
#####################################################################################################################
def Attention_UNet(input_shape, NUM_CLASSES=1, dropout_rate=0.0, batch_norm=True, LearnRate = 0.001):
    '''
    Attention UNet, 
...
#####################################################################################################################
def Attention_UNet_shallow(input_shape, NUM_CLASSES=1, dropout_rate=0.0, batch_norm=True, LearnRate = 0.001):
    '''
    Attention UNet,
    ...
    return model
#####################################################################################################################
def Attention_ResUNet(input_shape, NUM_CLASSES=1, dropout_rate=0.0, batch_norm=True, LearnRate = 0.001):
    '''
...
#####################################################################################################################
def Attention_ResUNet_shallow(input_shape, NUM_CLASSES=1, dropout_rate=0.0, batch_norm=True, LearnRate = 0.001):
    '''
    Rsidual UNet, with attention
